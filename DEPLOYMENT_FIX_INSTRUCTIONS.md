# Fix for Chatbot Issue After Vercel Deployment
...
## Solution
The `ChatWindow.tsx` file needs to be updated to use environment-appropriate backend URLs.

## Steps to Fix

### 1. Update the ChatWindow.tsx file
Replace the content of `src/components/ChatWindow.tsx` with the content from `ChatWindow.tsx.fixed` in this directory.
...
git commit -m "Fix chatbot backend URL for Vercel deployment"
