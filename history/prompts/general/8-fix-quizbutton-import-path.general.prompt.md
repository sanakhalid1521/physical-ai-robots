...
files:
 ...
 - E:\quarter-4\Hackathon-1\physical-AI\docs\chapter-2\intro.md
 - E:\quarter-4\Hackathon-1\physical-AI\docs\chapter-3\intro.md
 - E:\quarter-4\Hackathon-1\physical-AI\docs\chapter-4\intro.md
 - E:\quarter-4\Hackathon-1\physical-AI\docs\chapter-5\intro.md
 - E:\quarter-4\Hackathon-1\physical-AI\docs\intro.md
...
Fixed the QuizButton import path in all lesson files and chapter intro files. The original import path '@site/src/components/QuizButton' was incorrect as the component is located in a subdirectory. Updated all 38 files (32 lesson files + 6 intro files) to use the correct path '@site/src/components/QuizButton/QuizButton'. Also updated component usage from 'chapter={X}' to 'chapterNumber={X} lessonTitle="...".

## Outcome

- ✅ Impact: Fixed build errors caused by incorrect import path, ensuring quiz buttons work properly across all lessons and chapter introductions
- 🧪 Tests: none
- 📁 Files: 38 files updated with correct import path (32 lesson files + 6 intro files)
- 🔁 Next prompts: none
