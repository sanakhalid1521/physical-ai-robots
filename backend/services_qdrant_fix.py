    ...
    def _create_mock_qdrant_client(self):
        ...
        class MockQdrantClient:
            ...
            def search(self, collection_name, query_vector, limit, with_payload=True):
                ...
                return []  # Return empty list as search results
        ...
        try:
            ...
            try:
                ...
                self.qdrant_client.create_collection(
                    ...
                    vectors_config=models.VectorParams(size=384, distance=models.Distance.COSINE) if QDRANT_AVAILABLE else {"size": 384, "distance": "Cosine"},
                )
